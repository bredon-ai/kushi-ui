    ...
    >
      <div className="max-w-10xl mx-auto px-3 flex items-center justify-between h-16">
        ...
        <div className="hidden lg:flex items-center gap-4">
          ...
          <Link
            to="/booking"
            className="px-5 py-2 rounded-full bg-peach-300 text-white font-bold shadow-md hover:bg-peach-200 transition"
          >
            Book Now
          </Link>
          ...
          {isMobileMenuOpen && (
            ...
            >
              ...
              <Link
                ...
                className="block text-center mx-3 mb-3 px-4 py-3 rounded-full bg-gradient-to-r from-peach-300 to-navy-700 text-white font-bold shadow"
              >
                Book Now
              </Link>
